      ...
      <section className="relative flex items-center justify-center min-h-screen pt-24 pb-20 overflow-hidden">
        ...
        <div className="relative z-10 grid items-center max-w-6xl grid-cols-1 gap-16 px-6 md:grid-cols-2">
          ...
          <div className="flex flex-col items-center text-center md:text-left md:items-start">
            ...
            {/* Paragraph — slides in from the RIGHT */}
            <motion.p
              initial={{ opacity: 0, x: 80 }}
              animate={{ opacity: 1, x: 0 }}
            ...
            {/* Tagline — slides in from the LEFT with longer delay */}
            <motion.p
          ...
          >
            <motion.img
              src={heroTemplate}
              alt="StreamVibe UI"
              className="w-[560px] max-w-full rounded-2xl border border-white/10 shadow-2xl"
